		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#aapgemployeemgmt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aapgemployeemgmt-display": {
								"semanticObject": "aapgemployeemgmt",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aapg.employeemgmt",
									"url": sap.ui.require.toUrl("aapg/employeemgmt")
								}
							}
						}
					}
